...
const uint16_t GPIO_PIN[LEDn] = {LED1_GPIO_PIN, LED2_GPIO_PIN, LED3_GPIO_PIN, LED4_GPIO_PIN};
...
const uint32_t GPIO_CLK[LEDn] = {LED1_GPIO_CLK, LED2_GPIO_CLK, LED3_GPIO_CLK, LED4_GPIO_CLK};
 ...
 const uint16_t COM_CTS_PIN[COMn] = {EVAL_COM1_CTSPin};

 const uint16_t COM_RTS_PIN[COMn] = {EVAL_COM1_RTSPin};
...
GPIO_InitTypeDef GPIO_InitStructure;
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_All & ~(EVAL_COM1_RxPin | EVAL_COM1_TxPin);
